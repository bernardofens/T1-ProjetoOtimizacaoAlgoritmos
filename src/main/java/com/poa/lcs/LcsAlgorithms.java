...
public final class LcsAlgorithms {
          //construtor private para impedir instanciacao
        //isso reforca que a classe e utilitaria e so tem metodos estaticos
    private LcsAlgorithms() {
    }
    //interface public para lcs recursivo sem memo
    ...
    //helper recursivo funcao auxiliar que implementa o algoritmo recursivo
    ...
    //lcs dp bottom up funcao que implementa o algoritmo dp bottom up
    ...
    //lcs memoizacao top down funcao que implementa o algoritmo memoizacao top down
    ...
    //helper da memoizacao funcao auxiliar que implementa o algoritmo memoizacao
    ...
    //reconstructlcs funcao que retorna uma subsequencia maxima como string

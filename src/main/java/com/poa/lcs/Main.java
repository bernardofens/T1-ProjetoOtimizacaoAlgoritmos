...
/* classe que coordena os exemplos e o benchmark */
    ...
    public static void main(String[] args) {
        ...
        for (String a : args) {
            if ("--csv".equals(a)) {
                ...
                /* guarda os argumentos para usar como s1 e s2 */
                rest.add(a);
            }
        }

        /* lista de casos que o benchmark vai executar */
